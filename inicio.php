          ...
          <div class="carousel-item active" style="background-image: url('assets/img/slide/slide-1.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <h2 class="animate__animated animate__fadeInUp">#ConGrupoAQUAXesSeguroNadar.</h2>
                <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Conócenos</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="mx-auto d-flex justify-content-center">
          <div class="row text-light justify-content-center mx-auto">
            ...
            <div class="col-lg-2">
              <h4>CURSOS ADECUDADOS PARA TI</h4>
            </div>
            ...
            <div class="col-lg-2">
              <h4>INSTRUCTORES CAPACITADOS CONTINUAMENTE</h4>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
            ...
            <p class="description">Cursos adecuados para ti</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
            <div class="icon"><i class="icofont-chart-bar-graph"></i></div>
            <h4 class="title"><a href=""></a></h4>
            <p class="description">25 años de experiencia</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><i class="icofont-earth"></i></div>
            <h4 class="title"><a href=""></a></h4>
            <p class="description">Grupos reducidos</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
            <div class="icon"><i class="icofont-image"></i></div>
            <h4 class="title"><a href=""></a></h4>
            <p class="description">Instructores capacitados continuamente</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
            <div class="icon"><i class="icofont-settings"></i></div>
            <h4 class="title"><a href=""></a></h4>
            <p class="description">Instalaciones de primer nivel.</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
            <div class="icon"><i class="icofont-tasks-alt"></i></div>
            <h4 class="title"><a href=""></a></h4>
            <p class="description">Acondicionamiento físico.</p>
          </div>
        </div>
